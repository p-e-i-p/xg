...
const validateUserName = (rule:any,value:any,callback:any)=>{
  ...
  if(value === ""){
    ...
    callback(new Error("长度在4 到 12 个字符之间"))
...
const validatePhone = (rule:any,value:any,callback:any)=>{
  value = value.trim();
  // const phoneReg = /^1[3456789][0-9]{8}$/
...
const resetDate = (row: any, colum: any, cellValue: number, index: number) => {
  return formateData(cellValue);
};

const formatRole = (row: any, colum: any, cellValue: number, index: number) => {
